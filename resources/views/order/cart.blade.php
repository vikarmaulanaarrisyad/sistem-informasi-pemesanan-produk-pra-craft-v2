    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <a href="{{ route('dashboard') }}" rel="nofollow">Home</a>
                <span></span> Shop
                <span></span> Your Cart
            </div>
        </div>
                                ...
                                @foreach ($orderDetail as $item)
                                    <tr>
                                        <td class="image product-thumbnail"><img
                                                src="{{ Storage::url($item->product->image) }}" alt="#"></td>
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a
                                                    href="product-details.html">{{ $item->product->name }}</a></h5>
                                            <p class="font-xs">{{ $item->product->description }}
                                            </p>
                                        </td>
                                        <td class="price" data-title="Price"><span>Rp.
                                                {{ format_uang($item->product->price) }} </span></td>
                                        ...
                                        <td class="text-right" data-title="Cart">
                                            <span>Rp. {{ format_uang($item->total_price) }}</span>
                                        </td>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="custom_select">
                                            <select class="form-control select-active select2-hidden-accessible"
                                                ...
                                                dir="ltr" data-select2-id="2" style="width: 546px;"><span
                                                    class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-labelledby="select2-7tds-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-7tds-container" role="textbox"
